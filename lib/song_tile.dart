...
class SongTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return InkWell( // Use InkWell for that "TouchableHighlight" feel
      onTap: onTap,
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            PopupMenuButton<String>(
              ...
              color: const Color(0xFF1C1C1E), // Matches your secondary dark color
              ...
              itemBuilder: (BuildContext context) => [
                ...
                const PopupMenuItem(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.delete_outline, color: Color(0xFFFC3C44), size: 20),
                      SizedBox(width: 12),
                      Text('Delete', style: TextStyle(color: Color(0xFFFC3C44))),
                    ],
                  ),
                ),
              ],
